  ...
  const navGroups: SidebarNavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          path: '/search-keys',
          labelKey: 'nav.search_keys',
          metaKey: 'nav_meta.search_keys',
          icon: sidebarIcons.searchKeys,
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          path: '/usage-monitor',
          labelKey: 'nav.usage_monitor',
          metaKey: 'nav_meta.usage_monitor',
          icon: sidebarIcons.usageMonitor,
        },
        {
          path: '/model-pressure',
