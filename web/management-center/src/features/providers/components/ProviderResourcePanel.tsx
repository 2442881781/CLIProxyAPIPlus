...
export function ProviderResourcePanel({
  ...
  const logo = logoOverride ? { src: logoOverride, transparent: true } : PROVIDER_LOGOS[group.id];
  const providerTitle = titleOverride ?? t(`providersPage.providerNames.${group.id}`);
      ...
      <div className={styles.header}>
        <div className={styles.headerMain}>
          <div className={styles.titleArea}>
            ...
            {descriptionOverride ? (
              <p className={styles.providerDescription}>{descriptionOverride}</p>
            ) : null}
            {registrationUrl ? (
              <>
                <a
