...
export const TYPE_COLORS: Record<string, TypeColorSet> = {
  ...
  commandcode: {
    light: { bg: '#fff1e8', text: '#bf4b00' },
    dark: { bg: '#5b2504', text: '#ffb77e' },
  },
  opencode: {
    light: { bg: '#eef2ff', text: '#3730a3' },
    dark: { bg: '#29275f', text: '#c7d2fe' },
  },
  zhipu: {
    light: { bg: '#e8efff', text: '#1759c7' },
    dark: { bg: '#173b78', text: '#9fc0ff' },
  },
  devin: {
    light: { bg: '#f3f4f6', text: '#111827' },
    dark: { bg: '#25272b', text: '#f3f4f6' },
  },
  empty: {
