...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/access-keys", s.mgmt.ListAccessKeys)
		mgmt.POST("/access-keys", s.mgmt.CreateAccessKey)
		mgmt.PATCH("/access-keys", s.mgmt.PatchAccessKey)
		mgmt.DELETE("/access-keys", s.mgmt.DeleteAccessKey)
		mgmt.POST("/access-keys/rotate", s.mgmt.RotateAccessKey)
		mgmt.GET("/access-keys/usage", s.mgmt.GetAccessKeyUsage)
		mgmt.GET("/access-keys/usage-top", s.mgmt.GetAccessKeyUsageTop)
		mgmt.GET("/access-groups", s.mgmt.ListAccessGroups)
		mgmt.PUT("/access-groups", s.mgmt.PutAccessGroup)
		...
		mgmt.GET("/search-mcp", s.mgmt.GetSearchMCP)
		mgmt.PUT("/search-mcp", s.mgmt.PutSearchMCP)
