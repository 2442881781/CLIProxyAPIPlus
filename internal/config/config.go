...
type Config struct {
	...
	// UsageStatisticsEnabled toggles usage aggregation; persisted history is retained while collection is disabled.
	...
	// SearchKey defines upstream web search provider keys (Tavily, Exa, Firecrawl)
